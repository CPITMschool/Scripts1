...
cd $HOME
wget -O pulsar https://github.com/subspace/pulsar/releases/download/v0.7.4-alpha/pulsar-ubuntu-x86_64-skylake-v0.7.4-alpha
sudo chmod +x pulsar
...
echo ""
  echo "=================================================="
  printGreen "Subspace Gemini 3g v0.7.4 успішно встановлено"
  echo ""
...
printGreen "Під час встановлення ваша нода оновиться на актуальну мережу Gemini 3g v0.7.4. Ви згідні? (Y/N): "
read choice
