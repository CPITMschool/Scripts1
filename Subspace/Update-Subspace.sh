...
function update() {
printGreen "Розпочалось встановлення Subpsace Gemini 3f v.0.6.14"
cd $HOME
...
printGreen "Під час встановлення ваша нода оновиться на актуальну мережу Gemini 3f v.0.6.14. Ви згідні? (Y/N): "
read choice
