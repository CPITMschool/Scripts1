...
cd $HOME
wget -O pulsar https://github.com/subspace/pulsar/releases/download/v0.6.13-alpha/pulsar-ubuntu-x86_64-skylake-v0.6.13-alpha
sudo chmod +x pulsar
...
echo ""
  echo "=================================================="
  printGreen "Subspace Gemini 3f v0.6.11 успішно встановлено"
  echo ""
